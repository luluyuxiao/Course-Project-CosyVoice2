...
# def main():
#     # 1. 初始化模型
#     print("正在加载 CosyVoice 2 模型...")
#     cosyvoice = CosyVoice2('iic/CosyVoice2-0.5B', load_jit=False, load_trt=False, fp16=False)
#
#     # 2. 准备参数
#     ref_audio_path = 'ref.wav'  # 参考音频路径
#
#     # 参考音频里说的话（Prompt Text）
#     # 为了效果更好，填 ref.wav 里真实说的话
#     prompt_text = "对，这就是我，万人敬仰的太乙真人，虽然有点婴儿肥，但也掩不住我逼人的帅气。"
#
#     target_text = "<|zh|><|happy|>这是生成模型的期末project，利用了CosyVoice二代的测试，不仅能克隆音色，还能模仿情感，简直太强了！"
#
#     print(f"正在生成: {target_text}")
#
#     # 3. 执行推理
#     # 修正关键点：第三个参数直接传路径字符串 'ref.wav'
